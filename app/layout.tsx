...
export default function RootLayout({
  ...
  return (
    <html lang="et" className={`${inter.variable} ${cormorant.variable}`}>
          ...
          <header className="sticky top-0 z-40 border-b border-stone-200/70 bg-cream/70 px-4 py-3.5 backdrop-blur-xl md:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-sm border border-gold/40 bg-gradient-to-br from-gold/15 to-champagne text-lg shadow-sm">
                  ⚽
                </span>
                <div>
                  <h1 className="font-serif text-2xl font-bold leading-none tracking-wide text-navy md:text-[1.65rem]">
                    Jalka <span className="text-gold">MM 2026</span>
                  </h1>
                  <p className="eyebrow mt-1">Ennustusmäng</p>
                </div>
              </div>
              <TopNav />
            </div>
