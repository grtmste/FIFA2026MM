...
//
//   node scripts/generate_sf_pdf.mjs
//
...
const MATCHES = [
  [101, "T", "14.07", "22:00", "Prantsusmaa", "Hispaania"],
  [102, "K", "15.07", "22:00", "Inglismaa", "Argentiina"],
];

const BONUS = [
  ["Kummas mängus lüüakse avapoolajal rohkem nurgalööke?", 2],
  ["Mitmendal minutil teeb Prantsusmaa väravavaht esimese pallipuute?", 4],
  ["Kes (mängija) lööb Inglismaa vs Argentiina mängus esimese värava?", 7],
  ["Mitu kollast kaarti antakse Inglismaa ja Prantsusmaa võistkondade peale kokku?", 4],
  ["Millised võistkonnad jõuavad finaali?", 3],
  ["Kes võidab meie ennustusvõistluse?", 4],
];
...
textCentered(page, "POOLFINAAL", PAGE_W / 2, y, 11, bold, NAVY);
y -= 12;
...
page.drawText("BOONUSKÜSIMUSED - POOLFINAAL", { x: LM, y: cur, size: 8, font: bold, color: GREY });
cur -= 15;
...
const out = "scripts/Jalka_MM_2026_poolfinaal_fillable.pdf";
