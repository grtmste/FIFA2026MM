...
// 89-96, so the existing PDF import maps them straight onto the matches), plus
// the 1/16 bonus questions.
//
//   node scripts/generate_r16_pdf.mjs
//
...
const MATCHES = [
  [89, "L", "04.07", "20:00", "Kanada", "Maroko"],
  [90, "P", "05.07", "00:00", "Paraguay", "Prantsusmaa"],
  [91, "P", "05.07", "23:00", "Brasiilia", "Norra"],
  [92, "E", "06.07", "03:00", "Mehhiko", "Inglismaa"],
  [93, "E", "06.07", "22:00", "Portugal", "Hispaania"],
  [94, "T", "07.07", "03:00", "USA", "Belgia"],
  [95, "T", "07.07", "19:00", "Argentiina", "Egiptus"],
  [96, "T", "07.07", "23:00", "Šveits", "Colombia"],
];

const BONUS = [
  ["Mitu mängu läheb lisaajale?", 3],
  ["Mitu punast kaarti jagatakse?", 3],
  ["Mitmendal minutil lüüakse vooru avavärav?", 7],
  ["Millises mängus lüüakse kõige rohkem väravaid?", 4],
  ["Mitu kollast kaarti antakse Kanada vs Maroko mängus?", 4],
  ["Mitu väravat lüüakse vasaku jalaga?", 5],
];
...
textCentered(page, "1/16 FINAAL", PAGE_W / 2, y, 11, bold, NAVY);
y -= 12;
...
page.drawText("BOONUSKÜSIMUSED - 1/16", { x: LM, y: cur, size: 8, font: bold, color: GREY });
cur -= 15;
...
const out = "scripts/Jalka_MM_2026_1-16_fillable.pdf";
